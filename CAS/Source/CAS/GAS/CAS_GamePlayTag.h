...
namespace CAS_GamePlayTag {
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_State_Pick);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_State_Push);
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Effect_Attack_Charge);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Effect_Attack_Release);
