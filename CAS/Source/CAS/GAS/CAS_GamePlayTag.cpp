...
namespace CAS_GamePlayTag {
	...
	UE_DEFINE_GAMEPLAY_TAG(Ability_State_Pick, "Ability.State.Pick")
	UE_DEFINE_GAMEPLAY_TAG(Ability_State_Push, "Ability.State.Push")
	...
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Sound_Player, "GameplayCue.Sound.Player")
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Sound_Enemy, "GameplayCue.Sound.Enemy")
