...
protected:
	...
	virtual void ApplyGamePlayEffect(class ACAS_Character* Target, TSubclassOf<UGameplayEffect> GameplayEffectClass, int32 GameplayEffectLevel, FGameplayEffectContextHandle EffectContext) override;
