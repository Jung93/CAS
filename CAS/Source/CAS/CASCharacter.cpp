...
UAbilitySystemComponent* ACASCharacter::GetAbilitySystemComponent() const
{
...
void ACASCharacter::PossessedBy(AController* NewController)
{
...
void ACASCharacter::OnRep_PlayerState()
{
...
void ACASCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACASCharacter::Move);
...
void ACASCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACASCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
